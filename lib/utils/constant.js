...
export const FESTIVAL_START_DATE = new Date(2022,1,7)
export const FESTIVAL_END_DATE = new Date(2022,1,11)
export const timeZones = [
  { value: 'GMT', label: 'GMT', city:'London', timeZone: 'Europe/London' },
