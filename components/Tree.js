...
const Tree = React.forwardRef((props, ref) => {
	const { index, url, setLoaded, title, slug, participant, summary, loaded, setSelected, selected, setEvent, style, menu } = props;
	...
	const labelStyle = isSelected || menu ? { width: 200, marginLeft: 20 } : { width: 0, zIndex: 10000 };
